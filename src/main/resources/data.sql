...
VALUES
    ('Rohit Malpani', 2, 1, '9816662225', 2,
     '$2a$12$ZzTi.apOKBsI/WMCWH0Mn.zzpcLzyJ3TvqFxZ1/OrM7hDyu7DBVVu', TRUE, '2026-02-19 10:00:00+05:30', '2026-02-19 10:00:00+05:30'),
    ...
    ('Shubh', 2, 3, '7018437924', 1,
     '$2a$12$g59i7APUObBG0kw7KMdrouf8wRWG6IQQFTRf260NfHLZExvskrzi6', TRUE, '2026-02-19 10:00:00+05:30', '2026-02-19 10:00:00+05:30'),

    -- GLOBAL SYSTEM USER (for global JWT)
    ('GLOBAL SYSTEM USER', 2, 1, 'GLOBAL_USER', 1,
     '$2a$12$ZzTi.apOKBsI/WMCWH0Mn.zzpcLzyJ3TvqFxZ1/OrM7hDyu7DBVVu', TRUE, NOW(), NOW())
